...
const AcademyBanner = () => {
  ...
  return (
    <section 
      ref={ref}
      className={`py-16 bg-gradient-to-r from-primary via-secondary to-primary relative overflow-hidden transition-all duration-700 ${
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <Button
            ...
            size="xl"
            className={`bg-white text-primary hover:bg-white/90 font-bold shadow-lg hover:shadow-xl transition-all group ${
              isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
            }`}
